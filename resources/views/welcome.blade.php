...
<html class="no-js" lang="zxx">
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-8">
                            <div class="header-info-left">
                                <ul>                          
                                    <li>muzamilahmad729@gmail.com</li>
                                    <li>7006760272</li>
                                    <li>Tangmarg Pariswani</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <div class="place-cap">
                                ...
                                <div class="place-cap-bottom">
                                    <ul>
                                        ...
                                        <li><i class="fas fa-map-marker-alt"></i>Gulmarg</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="right-caption">
                            ...
                            <div class="support-caption">
                                <p>Let us have a tour to gulmarg to see the real nature. you will find dark forest with snow.</p>
                                <div class="select-suport-items">
                                    <label class="single-items">Gandola.
                                        <input type="checkbox" checked="checked active">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="single-items">Golf Club.
                                        <input type="checkbox" checked="checked active">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="single-items">Horse Riding.
                                        <input type="checkbox" checked="checked active">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="single-items">Snow Bike.
                                        <input type="checkbox" checked="checked active">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial text-center">
                                ...
                                <div class="testimonial-caption ">
                                    <div class="testimonial-top-cap">
                                        ...
                                        <p>So are you ready to book tour to Gulmarg.</p>
                                    </div>
                                    <!-- founder -->
                            ...
                            <div class="single-testimonial text-center">
                                ...
                                <div class="testimonial-caption ">
                                    <div class="testimonial-top-cap">
                                        <img src="assets/img/icon/testimonial.png" alt="">
                                        <p>The World's best tour in your life.</p>
                                    </div>
                                    <!-- founder -->
                                    <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                        <div class="founder-img">
                         ...
                         <div class="single-footer-caption mb-30">
                             ...
                             <div class="footer-tittle">
                                 <div class="footer-pera">
                                     <p>Have a nice tour to gulmarg. We are waiting for you.</p>
                                </div>
                             </div>
                         </div>
                       </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Don't Copy Contents <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Muzamil Ahmad</a>
